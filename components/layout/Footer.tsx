  ...
  const socialLinks = [
    {
      ...
      labelEn: 'Instagram @cotchbandung',
      labelId: 'Instagram @cotchbandung',
      icon: (
    ...
    },
    {
      ...
      labelEn: 'TikTok @cotchbandung',
      labelId: 'TikTok @cotchbandung',
      icon: (
        <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
    ...
    },
    {
      ...
      labelEn: 'X (Twitter) @cotchbandung',
      labelId: 'X (Twitter) @cotchbandung',
      icon: (
        <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
            ...
            <div className="footer__social">
              {socialLinks.map(item => (
                <a
                  ...
                  data-aria-label-en={item.labelEn}
                  data-aria-label-id={item.labelId}
                >
                  {item.icon}
                </a>
              ))}
